...
const SeatLayout = () => {
  ...
  return show ? (
    <motion.div 
      className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        ...
        <div className='mt-5 space-y-1'>
          {show.dateTime[date] ? (
            ...
            <p className='text-sm px-6 text-gray-500'>No shows available for this date.</p>
          )}
        </div>
      </motion.div>
      ...
      <motion.div 
        className='relative flex-1 flex flex-col items-center max-md:mt-16'
